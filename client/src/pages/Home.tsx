  ...
  const content = {
    es: {
      ...
      recinto: {
        ...
        ubicacion_desc: "Posicionada en el corazón del Caribe, a 48 millas al oeste del puerto de Casilda y 59 millas al este de la bahía de Cochinos. Conexión directa con rutas de comercio global. Conectividad terrestre y marítima integrada.",
        infraestructura: "Infraestructura Existente",
        infraestructura_desc: "Terminal multipropósito, fábrica de cereales, terminal especializada en productos del mar, refinería de petróleo, astilleros, servicios marítimos, marina, y acceso al polo turístico de Trinidad.",
        expansion: "Potencial de Expansión",
        expansion_desc: "8,962 hectáreas disponibles con 15 zonas operacionales. Áreas disponibles para construcción de terminal de contenedores. Fuerza de trabajo calificada. Infraestructura de clase mundial."
      },
      operadores: {
        title: "Operadores Portuarios Actuales",
        subtitle: "Infraestructura diversificada y operadores especializados en múltiples sectores",
        empresa1: "Terminal Multipropósito - Empresa Servicios Portuarios del Centro",
        desc1: "Operaciones multimodales de carga general, contenedores y carga especializada. Capacidad de manipulación versátil para diversos tipos de mercancías.",
        empresa2: "Fábrica de Cereales",
        desc2: "Instalación especializada en recepción, procesamiento y exportación de cereales. Infraestructura de almacenamiento y procesamiento de granos.",
        empresa3: "Terminal Especializada - Comercializadora de Productos del Mar",
        desc3: "Procesamiento y comercialización de productos pesqueros. Instalaciones refrigeradas y de valor agregado para productos del mar.",
        empresa4: "Refinería de Petróleo, Astilleros y Servicios Marítimos",
        desc4: "Refinería de petróleo, reparación y mantenimiento de buques, dique seco, y servicios marítimos integrales. Fuerza de trabajo calificada."
      },
      oportunidades: {
        ...
        logistica: "Logística",
        logistica_desc: "Terminal de contenedores, conectividad regional y eficiencia operativa",
        turismo: "Turismo",
        turismo_desc: "Marina, polo turístico de Trinidad y destino de clase mundial",
        pesca: "Pesca",
        pesca_desc: "Procesamiento de productos del mar y acuicultura sostenible",
        energia: "Energía",
        energia_desc: "Refinería existente y transición a energías renovables"
      },
      areas_desarrollo: {
        title: "Áreas de Desarrollo Prioritario",
        subtitle: "Oportunidades inmediatas para inversión con alto potencial de retorno",
        area1_title: "Terminal de Contenedores",
        area1_desc: "Áreas disponibles para construcción de terminal de contenedores de clase mundial. Infraestructura de apoyo existente y fuerza de trabajo calificada.",
        area2_title: "Complejo Turístico Náutico",
        area2_desc: "Marina de lujo de 300 atraques, resort de 5 estrellas, restaurantes y servicios premium. Conexión con polo turístico de Trinidad.",
        area3_title: "Parque Industrial Portuario",
        area3_desc: "Zona para manufacturas orientadas a exportación con acceso directo a muelles, refinería y servicios de aduanas integrados.",
        ...
        area5_desc: "Ampliación de instalaciones de procesamiento de pescado, acuicultura moderna y centro de investigación marina.",
        area6_title: "Hub Digital Portuario",
        area6_desc: "Centro de innovación tecnológica, blockchain para logística, IoT y automatización portuaria con conectividad terrestre y marítima."
      },
      marco: {
    ...
    en: {
      ...
      recinto: {
        ...
        ubicacion_desc: "Positioned in the heart of the Caribbean, 48 miles west of Casilda port and 59 miles east of Cochinos Bay. Direct connection with global trade routes. Integrated land and maritime connectivity.",
        infraestructura: "Existing Infrastructure",
        infraestructura_desc: "Multi-purpose terminal, grain processing facility, specialized marine products terminal, oil refinery, shipyards, maritime services, marina, and access to Trinidad tourism hub.",
        expansion: "Expansion Potential",
        expansion_desc: "8,962 available hectares with 15 operational zones. Areas available for container terminal construction. Qualified workforce. World-class infrastructure."
      },
      operadores: {
        title: "Current Port Operators",
        subtitle: "Diversified infrastructure and specialized operators in multiple sectors",
        empresa1: "Multi-Purpose Terminal - Central Territory Port Services Company",
        desc1: "Multimodal operations for general cargo, containers and specialized cargo. Versatile handling capacity for various types of merchandise.",
        empresa2: "Grain Processing Facility",
        desc2: "Specialized installation for grain reception, processing and export. Grain storage and processing infrastructure.",
        empresa3: "Specialized Terminal - Marine Products Trading",
        desc3: "Processing and commercialization of fishing products. Refrigerated facilities and value-added services for marine products.",
        empresa4: "Oil Refinery, Shipyards and Maritime Services",
        desc4: "Oil refinery, ship repair and maintenance, dry dock, and comprehensive maritime services. Qualified workforce."
      },
      oportunidades: {
        ...
        logistica: "Logistics",
        logistica_desc: "Container terminal, regional connectivity and operational efficiency",
        turismo: "Tourism",
        turismo_desc: "Marina, Trinidad tourism hub and world-class destination",
        pesca: "Fishing",
        pesca_desc: "Marine product processing and sustainable aquaculture",
        energia: "Energy",
        energia_desc: "Existing refinery and transition to renewable energy"
      },
      areas_desarrollo: {
        title: "Priority Development Areas",
        subtitle: "Immediate investment opportunities with high return potential",
        area1_title: "Container Terminal",
        area1_desc: "Available areas for world-class container terminal construction. Existing support infrastructure and qualified workforce.",
        area2_title: "Nautical Tourism Complex",
        area2_desc: "Luxury marina with 300 berths, 5-star resort, restaurants and premium services. Connection with Trinidad tourism hub.",
        area3_title: "Industrial Port Park",
        area3_desc: "Zone for export-oriented manufacturing with direct access to docks, refinery and integrated customs services.",
        ...
        area5_desc: "Expansion of fish processing facilities, modern aquaculture and marine research center.",
        area6_title: "Digital Port Hub",
        area6_desc: "Technology innovation center, blockchain for logistics, IoT and port automation with integrated land and maritime connectivity."
      },
      marco: {
